...
<%
                 ...
                 try
                 {
                  ...
                  try
                  {
                      ...
                      Query myquery=mysession.createQuery("from Subcategory where catid=:id");
                      ...
                      if(myresult.size()>0)
                      {
                          ...
                          for(int x=0;x<myresult.size();x++)
                          {
                            ...
                            out.println("<td align=center><a href='showproducts.jsp?id=" + obj.getSubcatid() + "'><img src='userimages/" + obj.getImage() + "' width='200px' height='200px'>"
                                    + "<br> " + obj.getSubcatname() + "</a></td>");
                            counter++;
                            if(counter==4)
                            {
                            out.println("</tr><tr>");
